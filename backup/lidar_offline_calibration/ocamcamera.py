...
#
    ...
    test_img_path = "/home/ccha97u/Documents/calibration/lidar_offline_calibration/sandbox/raw/frame_vc1_00.bmp"
    ocam_file = "/home/ccha97u/Downloads/ocam_intrinsics.txt"
    ocam = OcamCamera(ocam_file)
    distorted_image = cv2.imread(test_img_path)
    undistort_image= ocam.undistort_image(distorted_image, 1920, 1080)
    cv2.imwrite("./undistorted_image.jpg", undistort_image)
