 ...
 */
ImuData imuConverter(const ImuData &imu_in, const Eigen::Matrix3d& extRot, const Eigen::Quaterniond& extQRPY)
{
...
public:
    ...
    float imuGyrNoise = 0.001;
    float imuAccBiasN = 0.0002;
    float imuGyrBiasN = 0.00003;
    float imuGravity = 9.80511;
    Eigen::Matrix3d extRot;     // extrinsicRot
    Eigen::Quaterniond extQRPY; // extrinsicRPY
    ...
    IMUPreintegration()
    {
        ...
        Eigen::Vector3d extTrans(0, 0, 0);  // extrinsicTrans
    ...
    void imuHandler(const ImuData& imu_raw)
    {
        ...
        ImuData thisImu = imuConverter(imu_raw, extRot, extQRPY);
