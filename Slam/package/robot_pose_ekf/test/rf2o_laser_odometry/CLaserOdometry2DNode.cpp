...
bool CLaserOdometry2DNode::setLaserPoseFromTf()
{
...
#else
    transform.setOrigin(tf::Vector3(0.2, 0, 0.315));
#endif
    retrieved = true;
  }
  ...
  // std::cout << laser_tf.matrix() << std::endl;
...
bool CLaserOdometry2DNode::process(nav_msgs::Odometry::Ptr& odom)
{
...
void CLaserOdometry2DNode::publish(nav_msgs::Odometry& odom)
{
