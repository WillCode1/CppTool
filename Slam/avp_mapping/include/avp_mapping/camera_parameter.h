...
namespace g2o
{
  ...
  public:
    ...
    CameraParameters(double focal_length_x, double focal_length_y, const Vector2D &principle_point)
        : focal_length_x_(focal_length_x), focal_length_y_(focal_length_y), principle_point_(principle_point) {}
